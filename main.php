...
function stock_dashlet_func($mode=DASHLET_MODE_PREVIEW,$id="",$args=null) 
{
	...
	case DASHLET_MODE_GETCONFIGHTML:
		$output='
			<BR CLASS="nobr" />
			<LABEL FOR="symbol">Please enter stock symbol</LABEL>
			<BR CLASS="nobr" />
	...
	case DASHLET_MODE_INBOARD:
		...
		$stock_API = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=" . $stock_symbol . "&interval=1min&apikey=1NH2CEEGT5PIUG1Y";
